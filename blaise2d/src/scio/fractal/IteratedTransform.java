...
public class IteratedTransform {
     ...
     */
    public static Path2D.Double iteratedPath(
            Path2D.Double initialPath,
     ...
     */
    public static Vector<double[]> getSegments(Path2D.Double path){
    ...
    public static Vector<AffineTransform> getSegmentTransforms(Path2D.Double path){
