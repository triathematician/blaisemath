 ...
 * @author elisha
 */
internal class SvgNamespaceFilter : XMLFilterImpl() {
    @Throws(SAXException::class)
    override fun endElement(uri: String?, localName: String?, qName: String?) {
        super.endElement(if (uri == "") NAMESPACE else uri, localName, qName)
    }
    ...
    override fun startElement(
        ...
        super.startElement(if (uri == "") NAMESPACE else uri, localName, qName, atts)
    }

    companion object {
        private val NAMESPACE: String? = "http://www.w3.org/2000/svg"
    }
}