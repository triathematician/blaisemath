...
abstract class SvgElement {
    ...
    private var style: AttributeSet? = null
    private var otherAttr: MutableMap<QName?, Any?>? = null
    ...
    fun setStyle(@Nullable style: AttributeSet?) {
        this.style = style
    }

    @XmlAnyAttribute
    fun getOtherAttributes(): MutableMap<QName?, Any?>? {
        return otherAttr
    }

    fun setOtherAttributes(other: MutableMap<QName?, Any?>?) {
        otherAttr = other
    }
