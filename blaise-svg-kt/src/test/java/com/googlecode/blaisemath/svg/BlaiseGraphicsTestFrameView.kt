...
class BlaiseGraphicsTestFrameView(app: SingleFrameApplication?) : FrameView(app) {
    private fun initComponents() {
        ...
        PanAndZoomHandler.Companion.install(canvas1)
        menuBar = JMenuBar()
        jToolBar1 = JToolBar()
        jButton1 = JButton()
        jButton2 = JButton()
        ...
        val actionMap: ActionMap? = Application.getInstance(BlaiseGraphicsTestApp::class.java).context.getActionMap(BlaiseGraphicsTestFrameView::class.java, this)
        ...
        fileMenu.add(JMenuItem(actionMap.get("printSvg")))
        fileMenu.add(JMenuItem(actionMap.get("quit")))
        menuBar.add(fileMenu)
        val basicMenu = JMenu("Basic Objects")
        basicMenu.add(JMenuItem(actionMap.get("addPoint")))
        basicMenu.add(JMenuItem(actionMap.get("addSegment")))
        basicMenu.add(JMenuItem(actionMap.get("addRectangle")))
        basicMenu.add(JMenuItem(actionMap.get("addString")))
        basicMenu.add(JMenuItem(actionMap.get("addIcon")))
        menuBar.add(basicMenu)
        val setsMenu = JMenu("Object Sets")
        setsMenu.add(JMenuItem(actionMap.get("addPointSet")))
        setsMenu.add(JMenuItem(actionMap.get("editPointSetStyle")))
        setsMenu.add(JMenuItem(actionMap.get("addDelegatingPointSet")))
        setsMenu.add(JMenuItem(actionMap.get("addDelegatingPointSet2")))
        setsMenu.add(JMenuItem(actionMap.get("addDelegatingGraph")))
        menuBar.add(setsMenu)
        val compMenu = JMenu("Compound Objects")
        compMenu.add(JMenuItem(actionMap.get("addLabeledShape")))
        compMenu.add(JMenuItem(actionMap.get("addLabeledPoint")))
        compMenu.add(JMenuItem(actionMap.get("addArrow")))
        compMenu.add(JMenuItem(actionMap.get("add2Point")))
        compMenu.add(JMenuItem(actionMap.get("addDraggableSegment")))
        compMenu.add(JMenuItem(actionMap.get("addRay")))
        compMenu.add(JMenuItem(actionMap.get("addLine")))
