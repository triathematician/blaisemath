...
class SvgRootTest {
    ...
    fun testWrite() {
        val r = SvgRoot()
        r.addElement(SvgRectangle())
        val text: String = SvgRoot.Companion.saveToString(r)
        TestCase.assertEquals("""<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
""",
    ...
    @Throws(IOException::class)
    fun testLoad() {
        SvgRoot.Companion.load(SvgRootTest::class.java.getResource("resources/test.svg").openStream())
        SvgRoot.Companion.load(SvgRootTest::class.java.getResource("resources/test2.svg").openStream())
        SvgRoot.Companion.load(SvgRootTest::class.java.getResource("resources/test3.svg").openStream())
        SvgRoot.Companion.load("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "<rect height=\"0.0\" rx=\"0.0\" ry=\"0.0\" width=\"0.0\" x=\"0.0\" y=\"0.0\"/>"
                + "</svg>")
        SvgRoot.Companion.load("<svg><rect height=\"0.0\" rx=\"0.0\" ry=\"0.0\" width=\"0.0\" x=\"0.0\" y=\"0.0\"/></svg>")
        val r2: SvgRoot = SvgRoot.Companion.load("<svg xmlns:xlink=\"http://www.w3.org/1999/xlink\"><image xlink:href=\"file:src/test/resources/com/googlecode/blaisemath/util/resources/cherries.png\"/></svg>")
        TestCase.assertTrue(r2.elements[0] is SvgImage)
    }
}