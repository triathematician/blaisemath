...
class SvgUtilsTest {
    @Test
    fun testParseLength() {
        Assert.assertEquals(0.0, SvgUtils.parseLength(null))
        Assert.assertEquals(0.0, SvgUtils.parseLength("not a number"))
        Assert.assertEquals(0.0, SvgUtils.parseLength("auto"), 1e-3)
        Assert.assertEquals(0.0, SvgUtils.parseLength("50.5%"), 1e-3)
        Assert.assertEquals(12.0, SvgUtils.parseLength("12"), 1e-3)
        Assert.assertEquals(15.5999, SvgUtils.parseLength("12px"), 1e-3)
        Assert.assertEquals(12.0, SvgUtils.parseLength("12pt"), 1e-3)
        Assert.assertEquals(864.0, SvgUtils.parseLength("12in"), 1e-3)
        Assert.assertEquals(143.4599, SvgUtils.parseLength("12em"), 1e-3)
        Assert.assertEquals(-143.4599, SvgUtils.parseLength("-12ex"), 1e-3)
        Assert.assertEquals(16.2499, SvgUtils.parseLength("12.5px"), 1e-3)
    }
}