 ...
 */
class PaletteSerializer : JsonSerializer<Palette?>() {
    @Throws(IOException::class)
    override fun serialize(value: Palette?, gen: JsonGenerator?, serializers: SerializerProvider?) {
        gen.writeString(AttributeSetCoder().encode(toAttributeSet(value)))
    }
    ...
    companion object {
         ...
         */
        fun toAttributeSet(pal: Palette?): AttributeSet? {
