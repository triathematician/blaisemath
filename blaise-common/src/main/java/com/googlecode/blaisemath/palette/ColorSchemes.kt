 ...
 */
object ColorSchemes {
    private val LOG = Logger.getLogger(ColorSchemes::class.java.name)
    val BASIC: String? = "BASIC"
    val GREEN_ARMITAGE: String? = "GREEN_ARMITAGE"
    val GLASBEY: String? = "GLASBEY"
    val CATEGORY10: String? = "CATEGORY10"
    val CATEGORY20: String? = "CATEGORY20"
    val CATEGORY20B: String? = "CATEGORY20B"
    val CATEGORY20C: String? = "CATEGORY20C"
    val BLUES: String? = "BLUES"
    private val SCHEMES: MutableMap<String?, ColorScheme?>? = Maps.newLinkedHashMap()

    /**
     * Get set of static schemes by name.
     * @return schemes
     */
    fun schemes(): MutableSet<String?>? {
        loadSchemes()
        return Collections.unmodifiableSet(SCHEMES.keys)
    }
     ...
     * @return scheme
     */
    fun scheme(schemeId: String?): Optional<ColorScheme?>? {
        loadSchemes()
