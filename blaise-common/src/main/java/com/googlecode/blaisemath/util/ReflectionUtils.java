...
public class ReflectionUtils {
     ...
     */
    public static Optional<Method> findStaticMethodOrNull(Class type, String name, Class... paramTypes) {
        try {
     ...
     * @return method if found
     */
    public static Optional<Method> findStaticMethodOrNull(Class type, String[] names, Class... paramTypes) {
        for (String n : names) {
            Optional<Method> m = findStaticMethodOrNull(type, n, paramTypes);
            if (m.isPresent()) {
                return m;
            }
        }
     ...
     */
    public static Optional<Constructor> findConstructorOrNull(Class type, Class... paramTypes) {
        try {
