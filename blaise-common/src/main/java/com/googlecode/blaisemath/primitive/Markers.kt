...
import com.googlecode.blaisemath.geom.circle2
import com.googlecode.blaisemath.geom.plus
...
object Markers {
    ...
    /** Markers, both loaded via [ServiceLoader] and statically defined. */
    @JvmStatic
    val availableMarkers by lazy {
        ServiceLoader.load(Marker::class.java).toList() + listOf(
                BLANK, CIRCLE, SQUARE, DIAMOND, TRIANGLE, STAR, STAR7, STAR11, PLUS, CROSS, TARGET,
