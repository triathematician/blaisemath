...
import sequor.control.gestures.GestureGenerator;
...
public class MarkovTest extends TestCase {
    ...
    public void testForwardViterbi() throws Exception {
        ...
        R2[] observations = {
            ...
            new R2(10,-20),
            new R2(90,1)};              
//        String[] hiddenStates=GestureGenerator.moveStates;
//        startProb=GestureGenerator.getStartProb(0.2);
//        transProb=GestureGenerator.getTransProb(0.1,0.4,0.1,0.1);
//        emitProb=GestureGenerator.getEmitProb();
...
//        assertEquals("[right, left, down, up]", GestureGenerator.clipOutput(result.vitPath).toString());
    }
}
