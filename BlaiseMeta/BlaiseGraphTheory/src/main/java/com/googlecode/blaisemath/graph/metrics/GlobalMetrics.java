...
public final class GlobalMetrics {
     ...
     */
    public static GraphMetric<Integer> COMPONENTS = new GraphMetric<Integer>() {
     ...
     */
    public static GraphMetric<Integer> ORDER = new GraphMetric<Integer>() {
        public String getName() {
            return "Order";
        }
     ...
     */
    public static GraphMetric<Integer> EDGE_NUMBER = new GraphMetric<Integer>() {
        public String getName() {
            return "Edge Number";
        }
     ...
     * possible)
     */
    public static GraphMetric<Double> DENSITY = new GraphMetric<Double>() {
        public String getName() {
            return "Link Density";
        }
     ...
     */
    public static GraphMetric<Double> DEGREE_AVERAGE = new GraphMetric<Double>() {
        public String getName() {
     ...
     */
    public static GraphMetric<Integer> DIAMETER = new GraphMetric<Integer>() {
        public String getName() {
            return "Diameter";
        }
     ...
     */
    public static GraphMetric<Integer> RADIUS = new GraphMetric<Integer>() {
        public String getName() {
            return "Radius";
        }
     ...
     */
    public static GraphMetric<Double> CLUSTERING_A = new GraphMetric<Double>() {
        public String getName() {
            return "Clustering A";
        }
     ...
     * directed case, measures "transitivity", i.e. when a->b,b->c implies a->c
     */
    public static GraphMetric<Double> CLUSTERING_B = new GraphMetric<Double>() {
        public String getName() {
            return "Clustering B";
        }
    ...
    public static <V> int[] triples(Graph<V> graph) {
        ...
        for (V node : graph.nodes()) {
            ...
            int dist1 = g1.size();
            int aDist1 = GraphUtils.subgraph(graph, g1).edgeCount();
