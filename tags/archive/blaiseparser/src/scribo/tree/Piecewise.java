...
public class Piecewise extends FunctionTreeFunctionNode {
    ...
    public Piecewise(Domain a, Domain b) {
        super(new Operation.Add(a, b));
    }

    @Override
    public void initFunctionType() {
        setFunctionNames(null, null, null, null);
    }
    ...
    public static class Domain extends FunctionTreeFunctionNode {
        ...
        public Domain(FunctionTreeNode argument) {
            super(argument);
            initDomain();
        }

        public Domain(FunctionTreeNode argument, double l, double u, boolean ls, boolean us) {
            super(argument);
            initDomain(l, u, ls, us);
        }

        public void initDomain() {
            initDomain(Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, false, false);
        }

        public void initDomain(double l, double u, boolean ls, boolean us) {
            lower = l;
            upper = u;
            lowerSharp = ls;
            upperSharp = us;
        ...
        public Double getValue(Double x) throws FunctionEvaluationException {
            ...
            if (x == lower && !lowerSharp) {
                return 0.0;
            }
            if (x == upper && !upperSharp) {
                return 0.0;
            }
            return x;
        }
    ...
    public static class Step extends FunctionTreeFunctionNode {
        ...
        public Step(FunctionTreeNode argument) {
            super(argument);
        }

        @Override
        public void initFunctionType() {
            setFunctionNames("step", null, null, null);
        }
    ...
    public static class Stepp extends FunctionTreeFunctionNode {
        ...
        public Stepp(FunctionTreeNode argument) {
            super(argument);
        }

        @Override
        public void initFunctionType() {
            setFunctionNames("stepp", null, null, null);
        }
    ...
    public static class Abs extends FunctionTreeFunctionNode {
        ...
        public Abs(FunctionTreeNode argument) {
            super(argument);
        }

        @Override
        public void initFunctionType() {
            setFunctionNames("abs", "stepp", null, null);
        }
