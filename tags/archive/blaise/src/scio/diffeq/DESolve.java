...
public class DESolve<C extends EuclideanElement<C>> {
    ...
    public C getMultipliedVector(BoundedFunction<C,C> field,C point,double size) throws FunctionValueException{
        return field.getValue(point).times(size/(field.maxValue().magnitude()));
    }
