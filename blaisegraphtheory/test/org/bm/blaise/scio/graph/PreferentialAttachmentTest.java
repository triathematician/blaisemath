...
public class PreferentialAttachmentTest {
    ...
    public void testGetLongitudinalSeededInstance_fixed_add_number() {
        ...
        Graph<Integer> slice = pref.slice(0.0);
        System.out.println("    result (t=0): " + slice.edgeNumber() + " edges, " + Graphs.printGraph(slice));
        System.out.println("    result (t=3): " + (slice=pref.slice(3.0)).edgeNumber() + " edges, " + Graphs.printGraph(slice));
        System.out.println("    result (t=6): " + (slice=pref.slice(6.0)).edgeNumber() + " edges, " + Graphs.printGraph(slice));
