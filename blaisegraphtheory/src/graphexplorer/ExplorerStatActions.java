...
class ExplorerStatActions {
    ...
    public void setController(GraphController controller) {
        ...
        boolean nonNull = controller != null && controller.getActiveGraph() != null;
    ...
    Action actionOf(StatEnum se) {
        if (!actionCache.containsKey(se)) {
            StatAction sa = new StatAction(se.s, se.metric);
            sa.setEnabled(controller != null && controller.getActiveGraph() != null);
    ...
    /** @return action corresponding to specified enum */
    Action actionOf(GlobalStatEnum se) {
        if (!actionCache.containsKey(se)) {
    ...
    public Action HIGHLIGHT = new AbstractAction("Highlight subset of nodes", ExplorerActions.loadIcon("highlight18")) {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (result == JOptionPane.OK_OPTION) {
                ...
                for (int i : selected)
                    set.add(glm.primaryNodes.get(i));
                controller.setNodeSubset(set);
            }
...
//            }
    ...
    public Action COOPERATION = new AbstractAction("Compute cooperation scores (experimental)", ExplorerActions.loadIcon("cooperation18")) {
        ...
        public void actionPerformed(ActionEvent e) {
            Graph active = controller.getActiveGraph();
            if (active == null)
                return;
...
//        CUSTOM("Custom", null),
    ...
    class GlobalStatAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            if (controller != null && controller.getActiveGraph() != null) {
                Object value = metric.value(controller.getActiveGraph());
