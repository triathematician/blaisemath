...
/**
 * Provides a <code>NodeSubsetMetric</code> computed by adding together the
 * return values of a <code>NodeMetric</code> for each node in the subset.
 *
 * @author Elisha Peterson
 */
public class AdditiveSubsetMetric<N extends Number> implements NodeSubsetMetric<N> {
     ...
     */
    public AdditiveSubsetMetric(NodeMetric<N> baseMetric) { this.baseMetric = baseMetric; }
