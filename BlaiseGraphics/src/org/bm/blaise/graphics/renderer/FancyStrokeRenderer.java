...
/**
 * Draws a stroke on the screen, using a fancy outlined style.
 * @author Elisha
 */
public class FancyStrokeRenderer implements ShapeRenderer {

    Color stroke;
    float thickness = 1f;

    public FancyStrokeRenderer(Color stroke) {
        this.stroke = stroke;
    }

    public FancyStrokeRenderer(Color stroke, float thickness) {
        this.stroke = stroke;
