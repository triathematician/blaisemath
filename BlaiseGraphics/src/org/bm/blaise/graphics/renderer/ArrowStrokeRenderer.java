 ...
 * @author Elisha
 */
public class ArrowStrokeRenderer extends BasicStrokeRenderer {

    public ArrowStrokeRenderer(Color stroke) { super(stroke); }
    public ArrowStrokeRenderer(Color stroke, float thickness) { super(stroke, thickness); }
    public ArrowStrokeRenderer(BasicStrokeRenderer rend) { super(rend.getStroke(), rend.getThickness()); }
