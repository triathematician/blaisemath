 ...
 */
public enum ShapeLibrary implements ShapeProvider {
    NONE(false, 0, 0, 0) { public Shape getShape(double x, double y, float radius) {
        return EMPTY_PATH;
    }},
    CIRCLE(true, 0, 0, 0){ public Shape getShape(double x, double y, float radius) {
        return new Ellipse2D.Double(x - radius, y - radius, 2*radius, 2*radius);
    }},
    SQUARE(true, 90, 0, 0){ public Shape getShape(double x, double y, float radius) {
        return new Rectangle2D.Double(x - radius/Math.sqrt(2), y - radius/Math.sqrt(2), 2*radius/Math.sqrt(2), 2*radius/Math.sqrt(2));
    }},
    DIAMOND(true, 90, 0, 0){ public Shape getShape(double x, double y, float radius) {
    ...
    TRIANGLE(true, 120, 90, 90){ public Shape getShape(double x, double y, float radius) {
    ...
    STAR(true, 72, 90, 90){ public Shape getShape(double x, double y, float radius) {
    ...
    STAR_7(true, 51, 90, 90){ public Shape getShape(double x, double y, float radius) {
    ...
    STAR_11(true, 33, 90, 90){ public Shape getShape(double x, double y, float radius) {
    ...
    PLUS(false, 90, 0, 0){ public Shape getShape(double x, double y, float radius) {
    ...
    CROSS(false, 90, 0, 0){ public Shape getShape(double x, double y, float radius) {
    ...
    CROSSHAIRS(false, 90, 0, 0){ public Shape getShape(double x, double y, float radius) {
        GeneralPath gp3 = new GeneralPath();
        gp3.moveTo((float) x, (float) (y-radius));
        gp3.lineTo((float) x, (float) (y+radius));
        gp3.moveTo((float) (x-radius), (float) y);
    ...
    HAPPY_FACE(true, 360, 90, 0){ public Shape getShape(double x, double y, float radius) {
    ...
    HOUSE(true, 360, -1, 0){ public Shape getShape(double x, double y, float radius) {
    ...
    SIMPLE_ARROW(false, 360, 0, 0){ public Shape getShape(double x, double y, float radius) {
        GeneralPath gp = new GeneralPath();
    ...
    TRIANGLE_SIDE(true, 360, 0, 0){ public Shape getShape(double x, double y, float radius) {
    ...
    ARROWHEAD(true, 360, 0, 0){ public Shape getShape(double x, double y, float radius) {
    ...
    TEARDROP(true, 360, 0, 0){ public Shape getShape(double x, double y, float radius) {
    ...
    CAR(true, 360, -1, 0){ public Shape getShape(double x, double y, float radius) {
     ...
     */
    ShapeLibrary(boolean fillable, int rSymmetry, int mSymmetry, int dir) {
    ...
    /**
     * Return shape with specified position and radius
     ...
     */
    abstract public Shape getShape(double x, double y, float radius);


    public Shape create(Point2D p, double angle, float radius) {
        Shape result = getShape(p.getX(), p.getY(), radius);
        return angle == 0 ? result
                : AffineTransform.getRotateInstance(angle, p.getX(), p.getY()).createTransformedShape(result);
    }
}
