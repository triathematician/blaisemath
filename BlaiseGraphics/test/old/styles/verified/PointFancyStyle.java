...
import old.styles.transferred.PointLabeledStyle;
import old.primitives.transferred.GraphicPointFancy;
...
public class PointFancyStyle extends PointLabeledStyle {
    ...
    public PointFancyStyle(ShapeLibrary shape, Anchor anchor) { super(shape, 6, anchor); }
    /** Construct with specified elements. */
    public PointFancyStyle(ShapeLibrary shape, BasicStroke stroke, Color strokeColor, Color fillColor, Anchor anchor) { super(shape, stroke, strokeColor, fillColor, 6, anchor); }
