...
public class StaticSpringLayout1 implements StaticGraphLayout<StaticSpringLayoutParameters> {
    ...
    public <C> Map<C, Point2D.Double> layout(
        ...
        LOG.log(LOG_LEVEL, "originalGraph, |V|={0}, |E|={1}, #components={2}, degrees={3}\n", 
        ...
        LOG.log(LOG_LEVEL, "graphForLayout, |V|={0}, |E|={1}, #components={2}, degrees={3}\n", 
        ...
        while (step < parm.minSteps || (step < parm.maxSteps && Math.abs(energyChange) > parm.energyChangeThreshold)) {
            ...
            if (step % 500 == 0) {
                LOG.log(LOG_LEVEL, "|Energy at step {0}: {1} {2}", 
        ...
        // report and clean up
        LOG.log(LOG_LEVEL, "StaticSpringLayout completed in {0} steps. The final energy "
