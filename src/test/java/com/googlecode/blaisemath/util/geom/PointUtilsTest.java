...
public class PointUtilsTest {
    ...
    public void testFormatPoint() {
        ...
        assertEquals("(0, 0)", PointUtils.formatPoint(new Point(), 0));
        assertEquals("(0.0, 0.0)", PointUtils.formatPoint(new Point(), 1));
        assertEquals("(1.02, -3.00)", PointUtils.formatPoint(new Point2D.Double(1.02,-3), 2));
    }
