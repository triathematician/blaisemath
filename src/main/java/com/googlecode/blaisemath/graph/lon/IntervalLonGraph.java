 ...
 */
public class IntervalLonGraph<V> implements LonGraph<V> {
    ...
    private IntervalLonGraph(boolean directed) {
     ...
     */
    public static <V> IntervalLonGraph<V> getInstance(boolean directed, int timeSteps,
        ...
        IntervalLonGraph<V> result = new IntervalLonGraph<V>(directed);
     ...
     * @return created graph
     */
    public static <V> IntervalLonGraph<V> getInstance2(boolean directed, int timeSteps,
