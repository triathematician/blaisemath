...
//        vg.setShapeStyle(boxStyle);
        List<Point3D[]> shapes = getBox(vg, new Point3D(.15, .15, .15), .3, .3, .3);
        shapes.addAll(getBox(vg, new Point3D(.55, .15, .15), .3, .3, .3));
        shapes.addAll(getBox(vg, new Point3D(.15, .55, .15), .3, .3, .3));
        shapes.addAll(getBox(vg, new Point3D(.15, .15, .55), .3, .3, .3));
        shapes.addAll(getBox(vg, new Point3D(.55, .55, .15), .3, .3, .3));
        shapes.addAll(getBox(vg, new Point3D(.55, .15, .55), .3, .3, .3));
        shapes.addAll(getBox(vg, new Point3D(.15, .55, .55), .3, .3, .3));
        shapes.addAll(getBox(vg, new Point3D(.75, .75, .75), .3, .3, .3));
        for (Point3D[] sh : shapes)
            sg.drawShape(sh);

        sg.drawPoint( new Point3D(1.06, 1.06, 1.06) );
