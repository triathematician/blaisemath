...
object GraphUtils {
    ...
    val GRAPH_SIZE_DESCENDING: Comparator<Graph<*>?>? = Comparator { o1: Graph<*>?, o2: Graph<*>? ->
        val size1 = o1.nodes().size
        val size2 = o2.nodes().size
        val edges1 = o1.edges().size
        val edges2 = o2.edges().size
