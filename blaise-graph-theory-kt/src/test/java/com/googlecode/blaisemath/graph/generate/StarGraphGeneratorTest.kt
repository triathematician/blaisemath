...
* #L%
*/   class StarGraphGeneratorTest {
    @Test
    fun testGetStarGraphInstance() {
        Assert.assertEquals("NODES: [0, 1, 2, 3]  EDGES: 0: [1, 2, 3] 1: [0] 2: [0] 3: [0]",
                GraphUtils.printGraph(StarGraphGenerator().apply(DefaultGeneratorParameters(false, 4))))
        Assert.assertEquals("NODES: [0, 1, 2, 3]  EDGES: 0: [1, 2, 3] 1: [] 2: [] 3: []",
                GraphUtils.printGraph(StarGraphGenerator().apply(DefaultGeneratorParameters(true, 4))))
    }
}