...
*/   class WattsStrogatzGeneratorTest {
    ...
    fun testWattsStrogatzGenerator() {
        ...
        val result1 = WattsStrogatzGenerator().apply(WattsStrogatzParameters(false, 10, 2, 0f))
        ...
        val result2 = WattsStrogatzGenerator().apply(WattsStrogatzParameters(false, 50, 4, .5f))
        println(result2)
