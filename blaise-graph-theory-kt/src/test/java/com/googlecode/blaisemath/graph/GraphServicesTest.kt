...
*/   class GraphServicesTest {
    @Test
    fun testGraphSuppliers() {
        val supp = GraphServices.generators()
        println(supp.size.toString() + " suppliers")
        println("- " + Joiner.on("\n- ").join(supp))
    }

    @Test
    fun testGlobalMetrics() {
        val supp = GraphServices.globalMetrics()
        println(supp.size.toString() + " global metrics")
        println("- " + Joiner.on("\n- ").join(supp))
    }

    @Test
    fun testNodeMetrics() {
        val supp = GraphServices.nodeMetrics()
        println(supp.size.toString() + " node metrics")
        println("- " + Joiner.on("\n- ").join(supp))
    }

    @Test
    fun testSubsetMetrics() {
        val supp = GraphServices.subsetMetrics()
        println(supp.size.toString() + " subset metrics")
        println("- " + Joiner.on("\n- ").join(supp))
    }

    @Test
    fun testStaticLayouts() {
        val supp = GraphServices.staticLayouts()
        println(supp.size.toString() + " static layouts")
        println("- " + Joiner.on("\n- ").join(supp))
    }

    @Test
    fun testIterativeLayouts() {
        val supp = GraphServices.iterativeLayouts()
        println(supp.size.toString() + " iterative layouts")
        println("- " + Joiner.on("\n- ").join(supp))
    }
}