...
* #L%
*/   class WheelGraphGeneratorTest {
    @Test
    fun testGetWheelGraphGeneratorInstance() {
        println("getWheelGraphGeneratorInstance")
        Assert.assertEquals("NODES: [0, 1, 2, 3, 4]  EDGES: 0: [1, 2, 3, 4] 1: [0, 2, 4] 2: [0, 1, 3] 3: [0, 2, 4] 4: [0, 1, 3]",
                GraphUtils.printGraph(WheelGraphGenerator().apply(DefaultGeneratorParameters(false, 5))))
        Assert.assertEquals("NODES: [0, 1, 2, 3, 4]  EDGES: 0: [1, 2, 3, 4] 1: [2, 4] 2: [1, 3] 3: [2, 4] 4: [1, 3]",
                GraphUtils.printGraph(WheelGraphGenerator().apply(DefaultGeneratorParameters(true, 5))))
    }
}