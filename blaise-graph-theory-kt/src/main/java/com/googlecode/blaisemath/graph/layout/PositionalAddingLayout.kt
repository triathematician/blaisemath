 ...
 */
class PositionalAddingLayout : StaticGraphLayout<CircleLayoutParameters?> {
    ...
    override fun <N> layout(g: Graph<N?>?, curLocations: MutableMap<N?, Point2D.Double?>?, parameters: CircleLayoutParameters?): MutableMap<N?, Point2D.Double?>? {
