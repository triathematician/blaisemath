...
* #L%
*/internal object GraphGenerators {
    /**
     ...
     */
    fun createGraphWithEdges(parameters: DefaultGeneratorParameters?, edges: Iterable<Array<Int?>?>?): Graph<Int?>? {
     ...
     * @return list
     */
    fun intList(min: Int, max: Int): MutableList<Int?>? {
