...
* #L%
*/ /**
 * Graph generator that uses [DefaultGeneratorParameters].
 *
 * @author Elisha Peterson
 */
abstract class AbstractGraphGenerator(protected val name: String?) : GraphGenerator<DefaultGeneratorParameters?, Int?> {
    override fun toString(): String {
        return name
    }

    override fun createParameters(): DefaultGeneratorParameters? {
        return DefaultGeneratorParameters()
    }
}