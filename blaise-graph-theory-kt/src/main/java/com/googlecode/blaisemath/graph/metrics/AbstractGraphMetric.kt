...
abstract class AbstractGraphMetric<T>(private val name: String?, private val description: String?, private val supportsDirected: Boolean) : GraphMetric<T?> {
    ...
    fun supportsGraph(directed: Boolean): Boolean {
