 ...
 */
class ComponentCount : AbstractGraphMetric<Int?>("Component count", "Number of connected components in the graph.", true) {
    override fun apply(graph: Graph?): Int? {
        return GraphUtils.components<Any?>(graph).size
    }
}