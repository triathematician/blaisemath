 ...
 */
class CliqueCountTwo : AbstractGraphNodeMetric<Int?>("Clique count (radius 2)") {
    override fun <N> apply(graph: Graph<N?>?, node: N?): Int? {
        val neighborhood = GraphUtils.neighborhood(graph, node, 2)
