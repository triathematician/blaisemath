...
import org.bm.blaise.scio.graph.PrimeNumberGraph;
...
//        MyTestGraph png = new MyTestGraph();
        ...
        plot.getAdapter().getNodeStyler().setStyleDelegate(new Delegator<Object, PointStyle>(){
            public PointStyle of(Object o) {
                Integer i = (Integer) o;
                return new BasicPointStyle().fill(png.getColor(i)).stroke(null).radius((int) (1 + .5 * png.getValue(i)));
            }
        });
        
        plot.getAdapter().getNodeStyler().setTipDelegate(new Delegator<Object, String>(){
        ...
        plot.getAdapter().getNodeStyler().setLabelStyleDelegate(new Delegator<Object, StringStyle>(){
            public StringStyle of(Object o) {
                Integer i = (Integer) o;
                return new BasicStringStyle().color(png.getColor(i));
            }
        });
