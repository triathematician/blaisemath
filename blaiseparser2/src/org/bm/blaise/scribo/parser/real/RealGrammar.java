...
public class RealGrammar implements Grammar {
    ...
    static TreeMap<String, Double> CONSTANTS = new TreeMap<String, Double>() {{
        put("pi", Math.PI);
        put("e", Math.E);
    }};
    ...
    final static Map<String, Method> MULTARY_OPS = new TreeMap<String, Method>() {{
        try {
            put(",", null);
            put("+", RealGrammar.class.getMethod("add", double[].class));
            put(" ", RealGrammar.class.getMethod("multiply", double[].class));
...
//            put("min", java.lang.Math.class.getMethod("min", double.class, double.class));
            ...
            put("round", java.lang.Math.class.getMethod("round", double.class));
            ...
            put("random", RealGrammar.class.getMethod("random", double.class, double.class));
              put("rand", RealGrammar.class.getMethod("random", double.class, double.class));
    ...
    public Map<String, Method> multaryOperators() { return MULTARY_OPS; }
