...
public class SimulationFactory {
    ...
    public static Vector<Team> twoPlusGoalSimulation() {
        ...
        lionTeam.addAutoGoal(.01, wateringHole, Goal.CAPTURE, TaskGenerator.CONTROL_CLOSEST, 7.0);
        wildebeastTeam.addAutoGoal(0.5, lionTeam, Goal.FLEE, TaskGenerator.AUTO_GRADIENT, 1.0);
        wildebeastTeam.addAutoGoal(1.0, wateringHole, Goal.CAPTURE, TaskGenerator.CONTROL_CLOSEST, 1.0);
