...
//        System.out.println(cc2);
    ...
    public void testCLUSTERING() {
        ...
        assertEquals(0.0, GraphMetrics.CLUSTERING.value(GraphFactory.getCycleGraph(10, false)), 1e-6);
        assertEquals(0.0, GraphMetrics.CLUSTERING.value(GraphFactory.getCycleGraph(10, true)), 1e-6);
        assertEquals(1.0, GraphMetrics.CLUSTERING.value(GraphFactory.getCompleteGraph(10, false)), 1e-6);
        assertEquals(1.0, GraphMetrics.CLUSTERING.value(GraphFactory.getCompleteGraph(10, true)), 1e-6);
        assertEquals(3/41.0, GraphMetrics.CLUSTERING.value(SAMPLE_PADGETT), 0.0);
    }

    @Test
    public void testDEGREE_AVERAGE() {
        System.out.println("DEGREE_AVERAGE");
        assertEquals(2.0, GraphMetrics.DEGREE_AVERAGE.value(GraphFactory.getCycleGraph(10, false)), 1e-6);
        assertEquals(1.0, GraphMetrics.DEGREE_AVERAGE.value(GraphFactory.getCycleGraph(10, true)), 1e-6);
        assertEquals(3.6, GraphMetrics.DEGREE_AVERAGE.value(GraphFactory.getWheelGraph(10, false)), 1e-6);
        assertEquals(2.5, GraphMetrics.DEGREE_AVERAGE.value(SAMPLE_PADGETT), 0.0);
    }

    @Test
    public void testEDGE_NUMBER() {
    ...
    public void testORDER() {
        ...
        assertEquals(10, GraphMetrics.ORDER.value(GraphFactory.getCycleGraph(10, true)), 1e-6);
        assertEquals(10, GraphMetrics.ORDER.value(GraphFactory.getWheelGraph(10, false)), 1e-6);
        assertEquals(SAMPLE_AIRPORTS.order(), GraphMetrics.ORDER.value(SAMPLE_AIRPORTS), 0.0);
        assertEquals(SAMPLE_PADGETT.order(), GraphMetrics.ORDER.value(SAMPLE_PADGETT), 0.0);
    }
