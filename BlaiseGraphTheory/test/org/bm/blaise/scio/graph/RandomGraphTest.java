...
public class RandomGraphTest {
    ...
    public void testGetInstance_probability() {
        ...
        assertEquals(10, result1.order()); assertEquals(0, result1.edgeCount());
        result1 = RandomGraph.getInstance(10, 1f, true);
        assertEquals(10, result1.order()); assertEquals(100, result1.edgeCount());
        result1 = RandomGraph.getInstance(10, 1f, false);
        assertEquals(10, result1.order()); assertEquals(45, result1.edgeCount());
    ...
    public void testGetInstance_number_of_edges() {
        ...
        assertEquals(10, result1.order()); assertEquals(30, result1.edgeCount());
