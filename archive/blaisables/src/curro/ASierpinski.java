 ...
 * @author  ae3263
 */
public class ASierpinski extends javax.swing.JApplet {
    ...
    public void init() {
        try {
            java.awt.EventQueue.invokeAndWait(new Runnable() {
                public void run() {
                    initComponents();
                    FractalShape2D.Sierpinski sp1 = new FractalShape2D.Sierpinski();
                    plot2D1.add(sp1);
                    NumberSlider ns = new NumberSlider(210,10,sp1.getIterModel());
                    ns.setName("Iterations");
                    plot2D1.add(ns,3,5);
                    plot2D1.getVisometry().setDesiredBounds(-.4,-.3,1.4,1.1);
                }
            });
        } catch (Exception ex) {
            ex.printStackTrace();
