...
/**
 * A grid which can be placed atop an Integer2 visometry.
 * @author Elisha Peterson
 */
public class GridZ2D extends DynamicPlottable<Integer2> {
    ...
    public void drawDot(Graphics2D g, Integer2 v, Z2 point,double radius,boolean showCoord){
    ...
    @Override
    public void mouseMoved(MouseVisometryEvent<Integer2> e) {
        super.mouseMoved(e);
