...
/**
 * FunctionSampleSet2D displays a finite set of values of a function in some way... for example, boxes for Riemann sums; sticks and dots;
 ...
 */
public class FunctionSampleSet2D extends Plottable<Euclidean2> implements Decoration<Euclidean2,Function2D> {
    ...
    public FunctionSampleSet2D(Function2D parent){this(parent,-4.0,4.0,20);}
    public FunctionSampleSet2D(Function2D parent,double leftPoint,double rightPoint,int numSamples){
        this.parent=parent;
