...
// Local operations on the graph
    ...
    public Graph getNeighborhood(int v){
        Graph g=new Graph();
...
// Global operations on the graph
    ...
    public int glueTo(Graph g2,ArrayList<Integer> a,ArrayList<Integer> b){
