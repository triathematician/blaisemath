 ...
 * @author  ae3263
 */
public class _DoubleRangeTimerTest extends javax.swing.JFrame {
    
    Point2D point;
    
    /** Creates new form _DoubleRangeTimerTest */
    public _DoubleRangeTimerTest() {
        initComponents();
        point=new Point2D();
        plot2D1.add(point);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new _DoubleRangeTimerTest().setVisible(true);
            }
        });
    }
