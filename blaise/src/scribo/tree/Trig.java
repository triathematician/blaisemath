...
public class Trig {
    public static class Cos extends FunctionTreeFunctionNode {
        ...
        public Double getValue(TreeMap<Variable,Double> table){return Math.cos(argumentValue(table));}
    ...
    public static class Sin extends FunctionTreeFunctionNode {
        ...
        public Double getValue(TreeMap<Variable,Double> table){return Math.sin(argumentValue(table));}
    ...
    public static class Tan extends FunctionTreeFunctionNode {
        ...
        public Double getValue(TreeMap<Variable,Double> table){return Math.tan(argumentValue(table));}
    ...
    public static class Sec extends FunctionTreeFunctionNode {
        ...
        public Double getValue(TreeMap<Variable,Double> table){return 1/Math.cos(argumentValue(table));}
    ...
    public static class Csc extends FunctionTreeFunctionNode {
        ...
        public Double getValue(TreeMap<Variable,Double> table){return 1/Math.sin(argumentValue(table));}
    ...
    public static class Cot extends FunctionTreeFunctionNode {
        ...
        public Double getValue(TreeMap<Variable,Double> table){return 1/Math.tan(argumentValue(table));}
