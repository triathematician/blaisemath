...
public class Exponential {
    public static class Exp extends FunctionTreeFunctionNode {
        ...
        public Double getValue(TreeMap<Variable,Double> table){return Math.exp(argumentValue(table));}
    ...
    public static class Log extends FunctionTreeFunctionNode {
        ...
        public Double getValue(TreeMap<Variable,Double> table){return Math.log(argumentValue(table));}
    ...
    public static class Log2 extends FunctionTreeFunctionNode {
        ...
        public Double getValue(TreeMap<Variable,Double> table){return Math.log(argumentValue(table))/log2;}
    ...
    public static class Log10 extends FunctionTreeFunctionNode {
        ...
        public Double getValue(TreeMap<Variable,Double> table){return Math.log(argumentValue(table))/log10;}
    ...
    public static class Cosh extends FunctionTreeFunctionNode {
        ...
        public Double getValue(TreeMap<Variable,Double> table){return Math.cosh(argumentValue(table));}
    ...
    public static class Sinh extends FunctionTreeFunctionNode {
        ...
        public Double getValue(TreeMap<Variable,Double> table){return Math.sinh(argumentValue(table));}
