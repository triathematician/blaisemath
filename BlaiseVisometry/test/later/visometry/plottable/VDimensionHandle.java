...
import primitive.style.temp.DimensionHandleStyle;
...
public class VDimensionHandle<C> extends DynamicPlottable<C>
    ...
    public VDimensionHandle(C[] points, String label) {
        ...
        addPrimitive(entry = new DraggableVGraphicEntry(points, dhs, this));
    }
    ...
    public void mouseDragged(Object source, C current) {
        if (source == entry) {
            DimensionHandleStyle dhs = (DimensionHandleStyle) entry.renderer;
