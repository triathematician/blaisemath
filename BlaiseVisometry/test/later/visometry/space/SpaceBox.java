...
import graphics.GraphicMesh;
import primitive.style.temp.MeshStyle;
...
public class SpaceBox extends AbstractPlottable<Point3D> {
    ...
    public SpaceBox() {
        ...
        addPrimitive(new VGraphicEntry(getBox(new Point3D(.15, .15, .15), .3, .3, .3), style));
        addPrimitive(new VGraphicEntry(getBox(new Point3D(.55, .15, .15), .3, .3, .3), style));
        addPrimitive(new VGraphicEntry(getBox(new Point3D(.15, .55, .15), .3, .3, .3), style));
        addPrimitive(new VGraphicEntry(getBox(new Point3D(.15, .15, .55), .3, .3, .3), style));
        addPrimitive(new VGraphicEntry(getBox(new Point3D(.55, .55, .15), .3, .3, .3), style));
        addPrimitive(new VGraphicEntry(getBox(new Point3D(.55, .15, .55), .3, .3, .3), style));
        addPrimitive(new VGraphicEntry(getBox(new Point3D(.15, .55, .55), .3, .3, .3), style));
        addPrimitive(new VGraphicEntry(getBox(new Point3D(.65, .65, .65), .3, .3, .3), style));
    }
