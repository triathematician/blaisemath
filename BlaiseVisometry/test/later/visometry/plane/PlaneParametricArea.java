 ...
 */
public class PlaneParametricArea extends AbstractPlottable<Point2D.Double> {
    ...
    public PlaneParametricArea(MultivariateVectorialFunction func, double min1, double min2, double max1, double max2, int sample1, int sample2) {
        ...
        addPrimitive(entry = new VGraphicEntry(null, new MeshStyle()));
    }
    ...
    public MeshStyle getStyle() { return (MeshStyle) entry.renderer; }
    /** Set current style of stroke for this plottable */
    public void setStyle(MeshStyle newValue) { if (entry.renderer != newValue) { entry.renderer = newValue; firePlottableStyleChanged(); } }
