...
public class MeshRoot2D {
    ...
    public static GeneralPath findRoots(Function<R2, Double> function, double zValue, R2 p1, R2 p2, double refinement, double precision, int maxIterations) throws FunctionValueException {
    ...
    public static GeneralPath findRoots(Function<R2, Double> function, double zValue,
    ...
    public static Shape addSegment(GeneralPath shape,R2 p1, R2 p2, R2 p3) {
        try {
            if (p1 == null) {
    ...
    public static GeneralPath lineOnPlane(double zValue, R3 p1, R3 p2, R3 p3) {
