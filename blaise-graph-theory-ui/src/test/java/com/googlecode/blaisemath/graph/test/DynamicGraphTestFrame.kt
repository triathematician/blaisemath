...
*/   class DynamicGraphTestFrame : JFrame() {
    ...
    private fun randomLBActionPerformed(evt: ActionEvent?) { //GEN-FIRST:event_randomLBActionPerformed
        updateEL = true
        plot.getLayoutManager().applyLayout(RandomBoxLayout.getInstance(), null, RandomBoxLayout.BoxLayoutParameters(Rectangle2D.Double(-500, -500, 1000, 1000)))
    ...
    private fun circleLBActionPerformed(evt: ActionEvent?) { //GEN-FIRST:event_circleLBActionPerformed
        updateEL = true
        plot.getLayoutManager().applyLayout(CircleLayout.getInstance(), null, CircleLayout.CircleLayoutParameters(500.0))
