...
* #L%
*/   class StyleHintsTest {
    @Test
    fun testApplyHints() {
        val hints: MutableSet<String?>? = Sets.newHashSet()
        Assert.assertEquals(Color(50, 0, 0, 128), StyleHints.modifyColorsDefault(Color(50, 0, 0, 128), hints))
        hints.add(StyleHints.HIDDEN_HINT)
        Assert.assertEquals(Color(50, 0, 0, 0), StyleHints.modifyColorsDefault(Color(50, 0, 0, 128), hints))
        hints.remove(StyleHints.HIDDEN_HINT)
        hints.add(StyleHints.HIGHLIGHT_HINT)
        Assert.assertEquals(Color(114, 64, 64, 128), StyleHints.modifyColorsDefault(Color(50, 0, 0, 128), hints))
        hints.remove(StyleHints.HIGHLIGHT_HINT)
        hints.add(StyleHints.SELECTED_HINT)
        Assert.assertEquals(Color(50, 0, 0, 128), StyleHints.modifyColorsDefault(Color(50, 0, 0, 128), hints))
        Assert.assertNull(StyleHints.modifyColorsDefault(null, hints))
    }
}