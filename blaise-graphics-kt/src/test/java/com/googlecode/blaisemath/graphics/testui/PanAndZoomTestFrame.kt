    ...
    companion object {
         ...
         */
            try {
                ...
                Logger.getLogger(PanAndZoomTestFrame::class.java.name).log(Level.SEVERE, null, ex)
            ...
            /* Create and display the form */EventQueue.invokeLater { PanAndZoomTestFrame().isVisible = true }
        }
    }
