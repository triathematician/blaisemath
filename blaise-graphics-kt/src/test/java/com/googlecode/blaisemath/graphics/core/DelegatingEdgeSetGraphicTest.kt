...
* #L%
*/   class DelegatingEdgeSetGraphicTest {
    @Test
    fun testGetCoordinateManager() {
        val instance: DelegatingEdgeSetGraphic<*, *, *> = DelegatingEdgeSetGraphic<Any?, Any?, Any?>()
        val result: CoordinateManager<*, *>? = instance.coordinateManager
    }
}