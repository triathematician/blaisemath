 ...
 * #L%
 */   class SelectionTestFrame : JFrame() {
    /**
    ...
    private fun initComponents() {
        ...
        contentPane.add(resultL, BorderLayout.PAGE_END)
        pack()
    ...
    private var resultL: JLabel? = null // End of variables declaration//GEN-END:variables
    ...
    companion object {
         ...
         */
            try {
                ...
                Logger.getLogger(SelectionTestFrame::class.java.name).log(Level.SEVERE, null, ex)
            ...
            /* Create and display the form */EventQueue.invokeLater { SelectionTestFrame().isVisible = true }
        }
    }
    ...
    init {
        ...
        gc.getSelectionModel().addPropertyChangeListener { evt: PropertyChangeEvent? -> resultL.setText(String.format("<html><b>Selection:</b> %s", evt.getNewValue())) }
    }
}