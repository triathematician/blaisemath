    ...
    companion object {
         ...
         */
            try {
                ...
                Logger.getLogger(HelloWorldTest::class.java.name).log(Level.SEVERE, null, ex)
            ...
            /* Create and display the form */EventQueue.invokeLater { HelloWorldTest().isVisible = true }
