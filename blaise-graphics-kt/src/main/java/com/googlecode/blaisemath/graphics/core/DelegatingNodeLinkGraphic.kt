...
class DelegatingNodeLinkGraphic<S, E : EndpointPair<S?>?, G>(
        ...
        @Nullable nodeRenderer: Renderer<Point2D?, G?>?,
        @Nullable labelRenderer: Renderer<AnchoredText?, G?>?,
        @Nullable edgeRenderer: Renderer<Shape?, G?>?
) : GraphicComposite<G?>() {
    /** Point graphics  */
    ...
    @JvmOverloads
    constructor(
            @Nullable nodeRenderer: Renderer<Point2D?, G?>? = null,
            @Nullable labelRenderer: Renderer<AnchoredText?, G?>? = null,
            @Nullable edgeRenderer: Renderer<Shape?, G?>? = null
    ...
    fun setCoordinateManager(ptMgr: CoordinateManager<*, *>?) {
    ...
    fun getNodeLocations(): MutableMap<S?, Point2D?>? {
        return pointGraphics.getCoordinateManager().activeLocationCopy
    }

    fun setNodeLocations(pts: MutableMap<S?, Point2D?>?) {
