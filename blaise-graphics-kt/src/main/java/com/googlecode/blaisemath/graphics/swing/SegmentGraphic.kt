 ...
 */
class SegmentGraphic(start: Point2D, end: Point2D, loc: ArrowLocation?) : TwoPointGraphic(start, end) {
    /** Entry with the line  */
    protected var lineGraphic: PrimitiveGraphic<*, *>? = null
    /** Where arrows are displayed  */
    protected var arrowLoc: ArrowLocation? = null

    override fun initGraphics() {
        // ensure line is added first
        lineGraphic = JGraphics.path(GeneralPath())
