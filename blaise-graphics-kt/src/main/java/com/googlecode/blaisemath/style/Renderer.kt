 ...
 */
interface Renderer<S : Any, G : Any> {
    /**
     ...
     */
    fun render(primitive: S, style: AttributeSet, canvas: G)
     ...
     */
    fun boundingBox(primitive: S, style: AttributeSet, canvas: G?): Rectangle2D?
     ...
     */
    fun contains(point: Point2D, primitive: S, style: AttributeSet, canvas: G?): Boolean
     ...
     */
    fun intersects(rect: Rectangle2D, primitive: S, style: AttributeSet, canvas: G?): Boolean
}