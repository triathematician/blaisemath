...
public abstract class FunctionTreeFactory {
    ...
    public static FunctionTreeNode getFunction(String name, FunctionTreeNode argument) throws FunctionSyntaxException {
        ...
        if (argument instanceof ArgumentList) {
            return getFunction(name, ((ArgumentList) argument).arguments());
        }
        name = name.toLowerCase();
        if (name.equals("abs")) {
            return new Piecewise.Abs(argument);
        } else if (name.equals("step")) {
            return new Piecewise.Step(argument);
        } else if (name.equals("stepp")) {
            return new Piecewise.Stepp(argument);
        } else if (name.equals("cos")) {
            return new Trig.Cos(argument);
        } else if (name.equals("sin")) {
            return new Trig.Sin(argument);
        } else if (name.equals("tan")) {
            return new Trig.Tan(argument);
        } else if (name.equals("csc")) {
            return new Trig.Csc(argument);
        } else if (name.equals("sec")) {
            return new Trig.Sec(argument);
        } else if (name.equals("cot")) {
            return new Trig.Cot(argument);
        } else if (name.equals("sqr")) {
            return new Exponential.Sqr(argument);
        } else if (name.equals("sqrt")) {
            return new Exponential.Sqrt(argument);
        } else if (name.equals("cubert")) {
            return new Exponential.Cubert(argument);
        } else if (name.equals("exp")) {
            return new Exponential.Exp(argument);
        } else if (name.equals("log")) {
            return new Exponential.Log(argument);
        } else if (name.equals("ln")) {
            return new Exponential.Log(argument);
        } else if (name.equals("log2")) {
            return new Exponential.Log2(argument);
        } else if (name.equals("logtwo")) {
            return new Exponential.Log2(argument);
        } else if (name.equals("log10")) {
            return new Exponential.Log10(argument);
        } else if (name.equals("logten")) {
            return new Exponential.Log10(argument);
        } else if (name.equals("sinh")) {
            return new Exponential.Sinh(argument);
        } else if (name.equals("cosh")) {
            return new Exponential.Cosh(argument);
        } else if (name.equals("dx")) {
            return new Differentiator(argument, "x");
        } else if (name.equals("dy")) {
            return new Differentiator(argument, "y");
        } else if (name.equals("dz")) {
            return new Differentiator(argument, "z");
        }
    ...
    public static FunctionTreeNode getFunction(String name, Vector<FunctionTreeNode> arguments) throws FunctionSyntaxException {
        if (arguments == null || arguments.size() == 0 || name == null) {
            return null;
        }
        if (arguments.size() == 1) {
            return getFunction(name, arguments.get(0));
        }
        name = name.toLowerCase();
        try {
            if (name.equals("sum")) {
                return Series.getSum(arguments);
            } else if (name.equals("prod")) {
                return Series.getProd(arguments);
            } else if (name.equals("if")) {
            } else if (name.equals("d") || name.equals("diff")) {
                return Differentiator.getDiff(arguments);
            }
    ...
    public static FunctionRoot getFunction(String fnString) throws FunctionSyntaxException {
        ...
        if (result instanceof ArgumentList) {
            return new VectorFunctionRoot(result);
        }
     ...
     * @throws scribo.parser.FunctionSyntaxException
     */
    public static RealFunction getFunctionObject(final String fnString, final Variable var) throws FunctionSyntaxException {
        return new RealFunction() {
            ...
            public Double getValue(Double x) throws FunctionEvaluationException {
                return compiled.getValue(var, x);
            }

            public List<Double> getValue(List<Double> xs) throws FunctionEvaluationException {
                return compiled.getValue(var, xs);
            }
     ...
     */
    public static FunctionTreeLeaf getLeaf(
            String name) {
        if (name.equals("pi")) {
            return Constant.PI;
