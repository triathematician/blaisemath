...
public class Exponential {
    ...
    public static class Sqr extends FunctionTreeFunctionNode {
        public Sqr(FunctionTreeNode argument){super(argument);}
        public Double getValue(Double x){return x*x;}
        public void initFunctionType(){setFunctionNames("sqr",null,"sqrt",Sqrt.class);}
        @Override
    ...
    public static class Sqrt extends FunctionTreeFunctionNode {
        public Sqrt(FunctionTreeNode argument){super(argument);}
        public Double getValue(Double x){return Math.sqrt(x);}
        public void initFunctionType(){setFunctionNames("sqrt",null,"sqr",Sqr.class);}
        @Override
        public FunctionTreeNode derivativeTree(Variable v){
    ...
    public static class Cubert extends FunctionTreeFunctionNode {
        public Cubert(FunctionTreeNode argument){super(argument);}
        public Double getValue(Double x){return Math.pow(x,1/3);}
        public void initFunctionType(){setFunctionNames("cubert",null,null,null);}
        @Override
        public FunctionTreeNode derivativeTree(Variable v){
