 ...
 */
public class PathStyleBasicTest {

    @Test
    public void testSerialization() throws IntrospectionException {
        System.out.println("svgSerialization");
        PathStyleBasic sty = new PathStyleBasic().stroke(Color.red).strokeWidth(2f);
        assertEquals("stroke:#ff0000; stroke-width:2.0", StyleUtilsSVG.convertStyleToSVG(sty));
    }
