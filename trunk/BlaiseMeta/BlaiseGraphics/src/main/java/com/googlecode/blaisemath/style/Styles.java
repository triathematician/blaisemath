...
public final class Styles {
    ...
    public static final ShapeStyleBasic DEFAULT_SHAPE_STYLE 
            = fillStroke(Color.white, Color.black);
    public static final PathStyleBasic DEFAULT_PATH_STYLE 
            = strokeWidth(Color.black, 1f);
    public static final PointStyleBasic DEFAULT_POINT_STYLE 
            = new PointStyleBasic();
    public static final TextStyleBasic DEFAULT_TEXT_STYLE 
            = new TextStyleBasic();
    ...
    public static ShapeStyle defaultShapeStyle() {
        return DEFAULT_SHAPE_STYLE;
    }
    
    public static PathStyle defaultPathStyle() {
        return DEFAULT_PATH_STYLE;
    }
    
    public static PointStyle defaultPointStyle() {
