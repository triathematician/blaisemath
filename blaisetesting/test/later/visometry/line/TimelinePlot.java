...
//        validate();
    ...
    private static class TimelinePlotComponent extends PlotComponent<Double> {
        ...
        public TimelinePlotComponent() {
            ...
            mouseListener = new TimelinePlotMouseHandler((LineVisometry) visometry, this);
            ...
            plottables.add(axis = new TimelineAxis());
        }
    ...
    static class TimelinePlotMouseHandler
        ...
        public void mousePressed(MouseEvent e) {
            ...
            if (mode.equals("Alt+Button1")) { // interval resize mode
                Point2D.Double pt = vis.toWindow(vis.toLocal(pressedAt));
        ...
        public void mouseDragged(MouseEvent e) {
            Double coord = vis.toLocal(e.getPoint());
            Point2D.Double pt = vis.toWindow(coord);
            if (pressedAt != null) {
                if (mode.equals("Alt+Button1")) { // interval resize mode
                    ...
                    double diff = vis.toLocal(pressedAt) - coord;
        ...
        public void mouseReleased(MouseEvent e) {
            ...
            if (pressedAt != null && mode.equals("Alt+Button1")) { // interval resize mode
                double c1 = vis.toLocal(pressedAt);
                double c2 = vis.toLocal(e.getPoint());
        ...
        public void mouseWheelMoved(MouseWheelEvent e) {
            ...
            zoomPoint(vis.toLocal(mouseLoc),
