...
import org.bm.blaise.scio.function.utils.DemoField2D;
 ...
 */
public class PlaneVectorField extends AbstractPlottable<Point2D.Double> {
    ...
    public PointDirStyle getStyle() { return (PointDirStyle) entry.renderer; }
    /** Set current style of stroke for this plottable */
    public void setStyle(PointDirStyle newValue) { if (entry.renderer != newValue) { entry.renderer = newValue; firePlottableStyleChanged(); } }
