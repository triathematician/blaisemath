...
import primitive.style.ClockStyle;
 ...
 */
public class VClock<C> extends VAbstractPoint<C> {
    ...
    public ClockStyle getStyle() { return (ClockStyle) entry.style; }
    /** Sets current clock style */
    public void setStyle(ClockStyle style) { entry.style = style; firePlottableStyleChanged(); }
}
