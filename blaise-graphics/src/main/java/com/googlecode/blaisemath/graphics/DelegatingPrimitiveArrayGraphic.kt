...
class DelegatingPrimitiveArrayGraphic<S, O, G> : PrimitiveArrayGraphicSupport<O?, G?> {
    /** The source object  */
    ...
    constructor() {}
    constructor(source: S?, primitive: Array<O?>?, styler: ObjectStyler<S?>?, renderer: Renderer<O?, G?>?) {
